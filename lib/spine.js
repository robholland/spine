(function() {
  ...
  Events = {
    _add_callback: function(target, ev, callback) {
      var calls, name, _i, _len, _ref;
    ...
    bind: function(ev, callback) {
      return this._add_callback(null, ev, callback);
    },
    bind_for: function(target, ev, callback) {
      return this._add_callback(target, ev, callback);
    },
    _run_callbacks: function() {
      var args, cb, ev, list, target, _base, _i, _len, _ref;
      target = arguments[0], ev = arguments[1], args = 3 <= arguments.length ? __slice.call(arguments, 2) : [];
      ...
      for (_i = 0, _len = list.length; _i < _len; _i++) {
        cb = list[_i];
        if (!(cb.target != null) || (typeof (_base = cb.target).eql === "function" ? _base.eql(target) : void 0)) {
          if (cb.fn.apply(cb.target || this, args) === false) {
            break;
          }
        }
      }
    ...
    trigger: function() {
      ...
      return this._run_callbacks.apply(this, [null, ev].concat(__slice.call(args)));
    },
    trigger_for: function() {
      var args, ev, target;
      target = arguments[0], ev = arguments[1], args = 3 <= arguments.length ? __slice.call(arguments, 2) : [];
      return this._run_callbacks.apply(this, [target, ev].concat(__slice.call(args)));
    },
    _remove_callbacks: function(target, ev, callback) {
      var cb, i, list, name, _base, _base2, _i, _len, _len2, _len3, _ref, _ref2;
      if (!ev) {
        this._callbacks = {};
        return this;
      }
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        name = _ref[_i];
        list = (_ref2 = this._callbacks) != null ? _ref2[name] : void 0;
        if (!list) {
          continue;
        }
        if (!callback) {
        ...
        for (i = 0, _len3 = list.length; i < _len3; i++) {
          cb = list[i];
          if ((!(cb.target != null) || (typeof (_base2 = cb.target).eql === "function" ? _base2.eql(target) : void 0)) && cb.fn === callback) {
            list = list.slice();
            list.splice(i, 1);
            this._callbacks[name] = list;
            break;
    ...
    unbind: function(ev, callback) {
      return this._remove_callbacks(null, ev, callback);
    },
    unbind_for: function(target, ev, callback) {
      return this._remove_callbacks(target, ev, callback);
    }
  };
  Log = {
    trace: true,
  ...
  Model = (function() {
    ...
    Model.prototype.updateID = function(id) {
      var records;
    ...
    Model.prototype.bind = function() {
      var _ref;
      return (_ref = this.constructor).bind_for.apply(_ref, [this].concat(__slice.call(arguments)));
    };
    Model.prototype.trigger = function() {
      var _ref;
      return (_ref = this.constructor).trigger_for.apply(_ref, [this].concat(__slice.call(arguments)));
    };
    Model.prototype.unbind = function() {
      var _ref;
      return (_ref = this.constructor).unbind_for.apply(_ref, [this].concat(__slice.call(arguments)));
    };
    return Model;
  })();
  Controller = (function() {
    ...
    Controller.prototype.delay = function(func, timeout) {
      return setTimeout(func, timeout || 0);
    };
